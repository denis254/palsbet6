...
def Popular_Websites_that_Provide_Reliable_Football_Predictions(request):
    return render(request, 'free/Popular_Websites_that_Provide_Reliable_Football_Predictions.html')

def ads(request):
    return render(request, 'free/ads.html')

class AdsView(View):
    def get(self, request, *args, **kwargs):
        return HttpResponse('google.com, pub-4585289533583618, DIRECT, f08c47fec0942fa0')
